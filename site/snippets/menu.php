            ...
            <div class="submenu-wrapper contact-wrapper">
                ...
                <?php if ($site->vimeo()->isNotEmpty()) : ?>
                    <a href="<?= $site->vimeo() ?>" target="_blank" rel="noopener noreferrer">
                        <svg viewBox="0 0 32 26" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                ...
                <?php endif ?>
                <?php if ($site->vimeo()->email()) : ?>
                    <a href="mailto:<?= $site->email() ?>" target="_blank" rel="noopener noreferrer">
                        <svg viewBox="0 0 26 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
